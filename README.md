...
* **Gestión de Transacciones:** CRUD completo (Crear, Leer, Actualizar, Eliminar) conectado a base de datos.
* **Visualización Dinámica:** Gráficos e indicadores que se actualizan automáticamente.
* **Diseño Premium:** Interfaz moderna y responsiva utilizando **Tailwind CSS v4**.
* **Seguridad:** Manejo profesional de variables de entorno para proteger las API keys.
